...
if(isset($_POST['header-shiping']))
{
  ...
  $result = topheader($con,$header_info);
 if($result == true)
	 {
	 $msg = "<h5 style='text-align: center;color: green;'>Header Create</h5>";	
	 }else{
	 $msg = "<h5 style='text-align: center;color: green;'>Header Not Create</h5>";
	 }
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
		...
		<form name="top-header" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post">
        <div class="box-body">
              
                <div class="form-group">
				<label>Header Title</label>
                <input type="text" name="header_title" class="form-control select2 select2-hidden-accessible" style="width: 100%;"  >
                </div>
				...
				<input type="submit" name="header-shiping" class="form-control select2 select2-hidden-accessible" style="width: 100%;" value="SUBMIT" >
				</div>
				</div>
				</form>
