...
if(isset($_POST['add_tax']))
{
 ...
 $tax_info = array(
  ...
  $result = insert_tax($con, $tax_info);
  if($result = TRUE)
  {
	 $msg = "<h5 style='text-align: center;color: green;'>Add Tax Successfully</h5>";
  }else{
	  
	  $msg = "<h5 style='text-align: center;color: green;'>Tax Not Add Try Again </h5>";
  }
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- Default box -->
        ...
        <h3 class="box-title">Sales Tax</h3>
        ...
        <input type="text" name="tax_amount" class="form-control select2 select2-hidden-accessible" style="width: 100%;" required >
		</div>
		<div class="form-group">
        <label>State</label>                
		<select name="sales_state"  class="form-control select2 select2-hidden-accessible" required>
		<option value="">Select State</option>
		<?php
		$sql_states = "SELECT DISTINCT name FROM states where country_id = '231'";
		...
		<div class="form-group">            
        <input type="submit" name="add_tax" class="form-control select2 select2-hidden-accessible" style="width: 100%;" value="ADD SALESTAX" >
		</div>
		</div>
		</form>
