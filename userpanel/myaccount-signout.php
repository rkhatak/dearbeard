    ...
    <div id="myaccount">
    	<div class="container">
        	<div class="row">
            	<ol class="breadcrumb">
                  <li><a href="#">Home</a></li>
                  <li><a href="#">Signout Account</a></li>
                </ol>
                
                <div class="login-top">
                	<div class="confirmation"><i class="fa fa-check-square" aria-hidden="true"></i> ARE YOU SURE YOU WANT TO LOG OUT? <a href="logout.php"> CONFIRM AND LOG OUT</a></div>
                	<div class="row">
                    	<div class="col-sm-3">
                                              <div class="col-left">
