        ...
        <a  href="product-detail.php?product_id=<?php echo $data_product['product_id']; ?>" data-toggle="modal" class="quick"><li><i class="fa fa-eye" aria-hidden="true"></i></li></a>
        <li><i class="fa fa-cart-plus" aria-hidden="true"></i></li>
        <li><i class="fa fa-clock-o" aria-hidden="true"></i></li>
        </ul>
        <ul class="effect_text">
        <li><a  href="product-detail.php?product_id=<?php echo $data_product['product_id']; ?>">Quick View</a></li>
        <button href="#" class="homewishlist" value="<?php echo $data_product['product_id'];?>">Add to<br/> Wishlist</button>
        <li><a  href="quick-checkout.php?product_id=<?php echo $data_product['product_id']; ?>">Quick Checkout</a></li>
        </ul>
